...
//    private RotateAnimation reverseAnimation;  
    ...
    private void init(Context context) {  
        ...
        headerView = (RelativeLayout) inflater.inflate(R.layout.lv_header, null);  
...
//            lvHeaderArrowIv.clearAnimation();  
        ...
        case DONE:  
            ...
            lvHeaderProgressBar.setVisibility(View.GONE);  
//            lvHeaderArrowIv.clearAnimation();  
            lvHeaderArrowIv.setImageResource(R.drawable.setting);  
            lvHeaderTipsTv.setText("下拉刷新");  
            lvHeaderLastUpdatedTv.setVisibility(View.VISIBLE);  
            break;  
        }  
...
//        child.measure(LayoutParams.MATCH_PARENT, childHeightSpec);
    }  
...
//    public void setAdapter(ShuoAdapter adapter) {  
//        lvHeaderLastUpdatedTv.setText("最近更新:" + new Date().toLocaleString());  
//        super.setAdapter(adapter);  
//    } 
}  
